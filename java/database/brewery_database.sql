...
INSERT INTO breweries (brewery_id, brewery_name, website, state, city, address) VALUES (10, 'Land-Grant Brewing Company', 'https://landgrantbrewing.com/', 'Ohio', 'Columbus', '424 W Town St, Columbus, OH 43215')
INSERT INTO breweries (brewery_id, brewery_name, website, state, city, address) VALUES (11, 'Jackie O''s', 'https://jackieos.com/', 'Ohio', 'Athens', '25 Campbell St, Athens, OH 45701')
INSERT INTO breweries (brewery_id, brewery_name, website, state, city, address) VALUES (12, 'The Brew Kettle', 'https://thebrewkettle.com/', 'Ohio', 'Strongsville', '8377 Pearl Rd, Strongsville, OH 44136')
INSERT INTO breweries (brewery_id, brewery_name, website, state, city, address) VALUES (13, 'Great Lakes Brewing Company', 'https://www.greatlakesbrewing.com/', 'Ohio', 'Cleveland', '2516 Market Ave, Cleveland, OH 44113')
INSERT INTO breweries (brewery_id, brewery_name, website, state, city, address) VALUES (14, 'Brew Dog', 'https://www.brewdog.com/usa', 'Ohio', 'Canal Winchester', '96 Gender Rd, Canal Winchester, OH 43110')
...
INSERT INTO beers (beer_id, beer_name, brewery_name, style, description, abv, brewery_id, img_url) VALUES (28, 'Cottonmouth Crusher', 'Saugatuck Brewing Company', 'Sour', 'While you  may know that the Michigan Cottonmouth Snake is a fairly common snake, we can guarantee this beer is anything but common. Cottonmouth Crusher is a tart and funky sour ale with raspberry overtones. Once you’ve been bitten by the delicious pierce of this beer, you’re going to want to suck out all the flavor.', '6', 07, 'https://images.getbento.com/accounts/34290715f5f307dbcf732116ed8bbcd5/media/images/97112CMC_12_oz_Rendering.png?w=1200&fit=max&auto=compress,format')
...
INSERT INTO beers (beer_id, beer_name, brewery_name, style, description, abv, brewery_id, img_url) VALUES (36, 'Saber Tooth Tiger', 'Rhinegeist Brewery', 'Imperial IPA', 'Prehistorically hopped Imperial India Pale Ale that attacks the senses with potent notes of Papaya, Mango, and Peach- yet it finishes its prey (your palate) with a crisp clean citrus bitterness.', '8.5', 09, 'https://rhinegeist.com/wp-content/uploads/2018/08/STT_CanRender-768x1179.png')
...
INSERT INTO beers (beer_id, beer_name, brewery_name, style, description, abv, brewery_id, img_url) VALUES (55, 'Jet Black Heart', 'Brew Dog', 'Oatmeal Stout', '7', 'Jet Black Heart is back; back in black. With an amped up 7% ABV, this Nitro Oatmeal Stout is decadent to the core and loaded with heaps of oatmeal, delivering a red carpet of silky opulence. It’s overflowing with notes of bitter cacao, roasted coffee, and dark berry fruits. It’ll plunge you into the deep, dark, abyss.', 14, 'https://www.brewdog.com/media/catalog/product/cache/eb360c13587b21a8ac6c611a2762b864/j/b/jbh_3can_pyramid.png')
